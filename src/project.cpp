...
gui.Shoutdown(window);
return 0;
}

void project::Init(GLFWwindow *window, const char *glsl_version)
{
...
void project::Render(GLFWwindow *window)
{
    // Rendering
    ImGui::Render();
...
void project::Shoutdown(GLFWwindow *window)
{
    // Cleanup
